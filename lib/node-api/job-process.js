...
exports.processStage = async job => {
  ...
  } else if(job.name === 'stopStage') {
    return exports.stopStage(job);
  } else if(job.name === 'startOperations') {
    return exports.startOperations(job);
  }
};
...
exports.startOperations = async job => {
  ...
  try {
    ...
    _logger.error('Failed to collect target details.', {error: e});
    throw e;
  }
...
exports.startStage = async job => {
  ...
  queue.add('startOperations', data, {
    attempts: 1000,
    backoff: 20000,
